# Paste your Global API here, create a class for it. So that the model could be called from.
...
class DatabaseAPI:
    ...
    def main():
        ...
        """
        This things need to be in private, initiate localy instead of putting here.
        """
        ...
        """This is good, I want this to be inside the another class, folder, so that we abstracted this away.
        """
